...
### *** Live GCS Demo instance ***
 - As of project submission on 12/08/24 a running instance is available on GCS at http://34.57.125.12:8000 (as of 12/08/2024).  This will remaining running through course completion, and can be restarted at request if it is not available.  
